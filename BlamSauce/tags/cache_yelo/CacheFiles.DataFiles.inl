...
namespace Yelo { namespace DataFiles {
	...
	__declspec(naked) static void __cdecl CacheFilesInitialize_DataFilesOpenHook()
	{
	...
	__declspec(naked) static void __cdecl CacheFilesDispose_DataFilesCloseHook()
	{
	...
	__declspec(naked) static void __cdecl DataFileReadHook(void* buffer)
	{
