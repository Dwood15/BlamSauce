...
static float K_MEMORY_UPGRADE_INCREASE_AMOUNT = 1.5f;
...
namespace Yelo {
	...
	namespace Enums {
		enum {
			...
			// 0x40440000
				k_tag_base_address = k_physical_memory_base_address + Yelo::GameState::Enums::k_game_state_allocation_size,
			...
			// 0x41B40000
				k_tag_max_address         = k_tag_base_address + k_tag_allocation_size,
