/*
 * SEE LICENSE.md for GPLv3 license information
 */
#pragma once
#include "../../../models/animations/definitions.hpp"
namespace Yelo::Objects::Units::SeatBoarding {
	...
	class c_unit_seat_boarding_manager final {
		...
		void UnitApplyEffect(const datum_index unit_index, const datum_index effect, const tag_string &effect_marker) const {
			if (!effect.IsNull()) {
		...
		/// </param>
		void UnitExitFromSeat(const datum_index unit_index, const bool force_state = false, const bool force_exit = false) const {
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>	Ejects a unit from a seat. </summary>
		///
		/// <param name="unit_index">	Datum index of the unit. </param>
		...
		bool StartAnimation(const datum_index unit_index, const s_unit_datum *unit_datum, const Enums::unit_seat_animation animation) const {
			...
			animation_index = blam::animation_choose_random_permutation_internal(Enums::_animation_update_kind_affects_game_state, unit_datum->object.animation.definition_index,
																										animation_index);
