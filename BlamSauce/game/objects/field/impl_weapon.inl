...
namespace Yelo::Objects {
	...
	static bool WeaponDataFieldGetReal(const s_object_field_definition &field, s_weapon_data &weapon,
		...
		switch (field.definition_index) {
			case _weapon_field_real_heat:
				result.ptr.real = &weapon.heat;
				break;
			case _weapon_field_real_age:
				result.ptr.real = &weapon.age;
				break;
			case _weapon_field_real_light_power:
				result.ptr.real = &weapon.integrated_light_power;
				break;
	...
	static void *WeaponDataFieldMagazineGetIntegerImpl(const s_object_field_definition &field, Objects::s_weapon_data::s_magazine_state &magazine,
		...
		switch (field.definition_index) {
			case _weapon_field_integer_magazine_state:
				return CAST_PTR(short*, &magazine.state); // state is an _enum
