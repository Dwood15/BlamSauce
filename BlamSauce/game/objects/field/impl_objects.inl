...
namespace Yelo::Objects {
	static real *ObjectDataFieldGetRealImpl(const s_object_field_definition &field, s_object_data &object, cstring subdata_name) {
		...
		switch (field.definition_index) {
			...
			case _object_field_real_radius:
				return &object.radius;
				break;
			case _object_field_real_scale:
				return &object.scale;
				break;
			case _object_field_real_maximum_vitality: // Keep for backwards compatibility ONLY, value is incorrect
			case _object_field_real_maximum_health:
				return &object.damage.maximum_health;
				break;
			case _object_field_real_current_vitality: // Keep for backwards compatibility ONLY, value is incorrect
			case _object_field_real_maximum_shield:
				return &object.damage.maximum_shield;
				break;
			case _object_field_real_current_health:
				return &object.damage.health;
				break;
			case _object_field_real_current_shield:
				return &object.damage.shield;
				break;
		}
	}
	...
	static real_vector3d *UnitDataFieldGetVector(const s_object_field_definition &field, s_unit_data &unit) {
		...
		switch (field.definition_index) {
			case _unit_field_vector_desired_facing:
				return &unit.desired_facing_vector;
			case _unit_field_vector_desired_aiming:
				return &unit.desired_aiming_vector;
			case _unit_field_vector_aiming:
				return &unit.aiming_vector;
			case _unit_field_vector_aiming_velocity:
				return &unit.aiming_velocity;
			case _unit_field_vector_looking:
				return &unit.looking_vector;
			case _unit_field_vector_looking_angles:
				return reinterpret_cast<real_vector3d *>(&unit.looking_angles);
			case _unit_field_vector_looking_velocity:
				return &unit.looking_velocity;
			default:
				return nullptr;
		}
	}
	...
	static real_vector3d *ObjectDataFieldGetVector(const s_object_field_definition &field, s_object_header_datum &obj) {
		...
		switch (field.definition_index) {
			case _object_field_vector_position:
				return reinterpret_cast<real_vector3d *>(&object->position);
			case _object_field_vector_transitional_velocity:
				return &object->transitional_velocity;
			case _object_field_vector_forward:
				return &object->forward;
			case _object_field_vector_up:
				return &object->up;
			case _object_field_vector_angular_velocity:
				return &object->angular_velocity;
			case _object_field_vector_center:
				return reinterpret_cast<real_vector3d *>(&object->center);
		}
	...
	static bool ObjectDataFieldGetReal(const s_object_field_definition &field, s_object_header_datum &obj,
		...
		if (ObjectFieldIndexIsVector(field.definition_index)) {
			...
			value_ptr      = reinterpret_cast<real *>(ObjectDataFieldGetVector(field, obj));
		} else {
