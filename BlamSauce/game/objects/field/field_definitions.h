...
namespace Yelo::Objects {
	...
	static void ObjectFieldGetImpl(const s_object_field_definition (&list)[_SizeOfArray], cstring name, TObjectDatum &obj, _Inout_ TypeHolder &result,
	...
	real_vector3d *ObjectDataGetVectorByName(s_object_header_datum *header, cstring data_name) {
	...
	void ObjectDataSetRealByName(s_object_header_datum *header, cstring data_name, cstring subdata_name, real data_value) {
	...
	//////////////////////////////////////////////////////////////////////////
	//
	void WeaponTagDataTriggerSetRealByName(s_weapon_datum *weapon, long trigger_index, cstring data_name, cstring subdata_name, real data_value) {
	...
	//////////////////////////////////////////////////////////////////////////
	// Real
	void WeaponDataGetRealByName(s_weapon_datum *weapon, cstring data_name, _Inout_ TypeHolder &result) {
		ObjectFieldGetImpl(g_weapon_real_fields, data_name, weapon->weapon, result, (void *) nullptr, WeaponDataFieldGetReal);
	}

	void WeaponDataSetRealByName(s_weapon_datum *weapon, cstring data_name, real data_value) {
		ObjectFieldSetImpl(g_weapon_real_fields, data_name, weapon->weapon, data_value, (void *) nullptr, WeaponDataFieldGetReal);
	}

	//////////////////////////////////////////////////////////////////////////
	// magazine - Integer
	void WeaponDataMagazineGetIntegerByName(s_weapon_datum *weapon, long magazine_index, cstring data_name, cstring subdata_name, _Inout_ TypeHolder &result) {
	...
	void WeaponDataMagazineSetIntegerByName(s_weapon_datum *weapon, long magazine_index, cstring data_name, cstring subdata_name, long data_value) {
		if (magazine_index >= 0 && magazine_index < Enums::k_maximum_number_of_magazines_per_weapon) {
			Objects::s_weapon_data::s_magazine_state &magazine = weapon->weapon.magazines[magazine_index];
	...
	void UnitDataGetObjectIndexByName(s_unit_datum *unit, cstring data_name, _Inout_ TypeHolder &result);

	void UnitDataSetRealByName(s_unit_datum *unit, cstring data_name, real data_value);
	...
	//////////////////////////////////////////////////////////////////////////
	// Integer
	void UnitDataGetIntegerByName(s_unit_datum *unit, cstring data_name, _Inout_ TypeHolder &result) {
		ObjectFieldGetImpl(g_unit_integer_fields, data_name, unit->unit, result, (void *) nullptr, UnitDataFieldGetInteger);
	}

	void UnitDataSetIntegerByName(s_unit_datum *unit, cstring data_name, long data_value) {
	...
	//////////////////////////////////////////////////////////////////////////
	// Real
	void UnitDataGetRealByName(s_unit_datum *unit, cstring data_name, _Inout_ TypeHolder &result) {
