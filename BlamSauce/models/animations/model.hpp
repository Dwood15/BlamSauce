...
namespace Yelo {
	...
	namespace blam {
		...
		int16 __cdecl animation_choose_random_permutation_internal(long_enum render_or_affects_game_state, datum_index animation_graph_index, int32 animation_index);
	};
};
