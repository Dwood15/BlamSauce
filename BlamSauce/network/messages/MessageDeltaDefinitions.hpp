...
#pragma region packet non generic types
		...
		}; static_assert( sizeof(control_flags) == 0x4 );
		...
		struct					universal_variant_flags
		{
			...
			unsigned short : 16;
		}; static_assert( sizeof(universal_variant_flags) == 0x4 );
		struct					game_variant_flags
		{
			unsigned char flag1 : 1;
			unsigned char : 8; unsigned short : 16;
		}; static_assert( sizeof(game_variant_flags) == 0x4 );
		...
		struct					damage_data_flags
		{
			...
			unsigned char : 8; unsigned short : 16;
		}; static_assert( sizeof(damage_data_flags) == 0x4 );
