...
namespace Yelo {
	namespace Enums {
		...
		enum network_messsage_type {
			_network_messsage_type_message       = 0, // 'old' packets
			_network_messsage_type_message_delta = 1,
		};
		// Old halo packets
		enum {
			...
			//todo: look into why open sauce has these as false
#if FALSE
		...
		enum message_delta {
			...
			_message_delta_hud_add_item, // always written to local connection
			_message_delta_player_create,
			_message_delta_player_spawn, // always written to local connection
			_message_delta_player_exit_vehicle,
			_message_delta_player_set_action_result,
			_message_delta_player_effect_start, // always written to local connection
			_message_delta_unit_kill,
			_message_delta_client_game_update,
			_message_delta_player_handle_powerup,
			_message_delta_hud_chat, // always written to local connection
