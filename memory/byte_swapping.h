...
namespace Yelo {
	namespace blam {
		...
		void __cdecl byte_swap_data(Memory::s_byte_swap_definition *definition, void *address, int32 data_count = 1);

		void __cdecl byte_swap_data_explicit(cstring name, int32 size, byte_swap_code_t *codes, int data_count = 1, void *address = nullptr);
	};
};
