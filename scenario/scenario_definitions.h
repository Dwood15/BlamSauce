...
namespace Yelo {
	...
	namespace TagGroups {
		...
		struct scenario {
			...
			TAG_PAD(scnr_pad13, tag_block, 1); // Halo2. cs_script_data
			TAG_PAD(scnr_pad14, tag_block, 1);
