...
namespace Yelo {
	...
	namespace blam {
		real __cdecl periodic_function_evaluate(Enums::periodic_function function_type, real input);

		real __cdecl transition_function_evaluate(Enums::transition_function function_type, real input);
	};
};
