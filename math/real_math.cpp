...
namespace Yelo {
	//////////////////////////////////////////////////////////////////////////
	// real_vector2d
	real real_vector2d::Magnitude() const { return MATH_FLOAT_FUNC(sqrt)(this->i * this->i + this->j * this->j); }
	...
	//////////////////////////////////////////////////////////////////////////
	// real_vector3d
	real real_vector3d::Magnitude() const { return MATH_FLOAT_FUNC(sqrt)(this->i * this->i + this->j * this->j + this->k * this->k); }
