...
namespace Yelo {
	...
	namespace Objects {
		...
		public: // see YeloLib/Halo1/units/units_grenade_count_upgrade.inl
			static const size_t k_offset_zoom_level         = FIELD_OFFSET(s_unit_datum, unit.zoom_level);
			static const size_t k_offset_desired_zoom_level = FIELD_OFFSET(s_unit_datum, unit.desired_zoom_level);

			static const size_t k_offset_zoom_level_yelo         = FIELD_OFFSET(s_unit_datum, unit.zoom_level_yelo);
			static const size_t k_offset_desired_zoom_level_yelo = FIELD_OFFSET(s_unit_datum, unit.desired_zoom_level_yelo);
			...
			byte *GetZoomLevel() {
				...
				return result ? &this->zoom_level_yelo : &this->zoom_level;
			}
		...
		struct s_unit_datum {
			...
			s_unit_data   unit;
		}; static_assert(sizeof(s_unit_datum) == Enums::k_object_size_unit);
	};

	namespace blam {
		bool __cdecl unit_animation_state_interruptable(const Objects::s_unit_datum_animation_data &animation, short next_animation_state) {
			bool result = true;
		...
		bool __cdecl unit_animation_busy(const Objects::s_unit_datum_animation_data &animation) {
			bool result = false;
		...
		bool __cdecl unit_animation_state_loops(const Objects::s_unit_datum_animation_data &animation) {
			bool result = true;
		...
		bool __cdecl unit_animation_weapon_ik(const Objects::s_unit_datum_animation_data &animation) {
		...
		bool __cdecl unit_animation_vehicle_ik(const Objects::s_unit_datum_animation_data &animation) {
			bool result = true;
