...
namespace Yelo
{
	...
	namespace blam
	{
		...
		void __cdecl object_reconnect_to_map(datum_index object_index, __in_opt s_scenario_location* location_reference = nullptr);
		...
		int16 __cdecl objects_in_sphere(Flags::objects_find_flags find_flags, long_flags object_type_flags,
