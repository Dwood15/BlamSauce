...
// Rasterizer.cpp
	namespace Rasterizer
	{
		...
		static unsigned short* K_MAXIMUM_RENDERED_TRIANGLES_UPGRADE_ADDRESS_LIST[] = {
			CAST_PTR(unsigned short*,K_MAXIMUM_RENDERED_TRIANGLES_UPGRADE_ADDRESS_0),
			CAST_PTR(unsigned short*,K_MAXIMUM_RENDERED_TRIANGLES_UPGRADE_ADDRESS_1),
			CAST_PTR(unsigned short*,K_MAXIMUM_RENDERED_TRIANGLES_UPGRADE_ADDRESS_2),
			CAST_PTR(unsigned short*,K_MAXIMUM_RENDERED_TRIANGLES_UPGRADE_ADDRESS_3),
		};
