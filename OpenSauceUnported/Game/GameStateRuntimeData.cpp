...
#include "Game/GameStateRuntimeData.Scripting.inl"
		void InitializeScripting()
		{
			...
			Scripting::InitializeScriptFunction(Enums::_hs_function_runtime_vectors_reset, 
				scripting_runtime_vectors_reset_evaluate);
			...
			Scripting::InitializeScriptFunctionWithParams(Enums::_hs_function_runtime_vector_set, 
				scripting_runtime_vector_set_evaluate);
			Scripting::InitializeScriptFunctionWithParams(Enums::_hs_function_runtime_vector_operation, 
				scripting_runtime_vector_operation_evaluate);
			Scripting::InitializeScriptFunctionWithParams(Enums::_hs_function_runtime_vector_to_string, 
